...
kable(int_search_race %>% select(-`Total (by Race)`), caption="Table 9: Interview Search Outcomes by Race") %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"), full_width = FALSE)

kable(int_disp_race, caption="Table 10: Interview Disposition Outcomes by Race") %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"), full_width = FALSE)
...
kable(rslt %>% as.data.frame() %>%
  ...
  caption="Table 11: Population in Census Tracts which intersect UCPD Patrol Area") %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"), full_width = FALSE)
...
kable(weighted_est %>% as.data.frame() %>% summarize(`Total Population` = round(sum(total_pop)),
  ...
  caption="Table 12: Projected Population in UCPD Patrol Area") %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"), full_width = FALSE)
